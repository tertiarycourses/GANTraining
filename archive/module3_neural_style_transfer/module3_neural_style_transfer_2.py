...
# We build the Inception network with our batch of 3 images as input.
...
for i in range(iterations):
    ...
    fname = result_prefix + '_inception_%d.png' % i
    imsave(fname, img)
    end_time = time.time()
    print('Image saved as', fname)
    print('Iteration %d completed in %ds' % (i, end_time - start_time))

# Show the content image, style image and generate image
